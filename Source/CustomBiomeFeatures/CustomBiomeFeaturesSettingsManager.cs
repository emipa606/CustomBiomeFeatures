...
public class CustomBiomeFeaturesSettingsManager : ModSettings
{
    ...
    {
        var addition = 0f;
        if (CustomBiomeFeaturesMod.currentVersion != null)
        {
            addition += 25f;
            GUI.contentColor = Color.gray;
            Widgets.Label(new Rect(0, inRect.y, inRect.width, 25),
                "CBF.ModVersion".Translate(CustomBiomeFeaturesMod.currentVersion));
            GUI.contentColor = Color.white;
        }

        var buttonRect = new Rect(0, inRect.y + addition, inRect.width, 30);
        ...
        var biomeSettingsRect = new Rect(0, inRect.y + 70 + addition, inRect.width, inRect.height - 65);
        ...
        foreach (var biomeFeaturesSettings in biomeSettings)
        {
            ...
            DrawBiomeSettings(biomeRect, biomeFeaturesSettings);
